...
public class ParallaxLayer{
	   ...
	   public float distanceForRepetition;
	   ...
	   public ParallaxLayer(TextureRegion region,Vector2 parallaxRatio,Vector2 startPosition,Vector2 padding, boolean loopDecision, float distance){
		      this.region  = region;
		      this.parallaxRatio = parallaxRatio;
		      this.startPosition = startPosition;
		      this.padding = padding;
		      this.loop = loopDecision;
		      this.distanceForRepetition = distance;
		   }
	}
