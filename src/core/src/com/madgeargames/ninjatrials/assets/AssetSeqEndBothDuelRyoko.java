...
public class AssetSeqEndBothDuelRyoko {

    // uso para debug:
    private static final String TAG = AssetSeqEndBothDuelRyoko.class.getName();

    // Animaciones:
    public AnimationNinja anim_sc08_sho_lose;
    ...
    // Texturas:
    public AtlasRegion sc08_ryoko_win;
    ...
    private String TEXTURE_ATLAS_OBJECTS = "images/seqEndBothDuelRyoko.pack";
    ...
    public void load() {
        ...
        regions = atlas.findRegions("anim_sc08_sho_lose");
        anim_sc08_sho_lose = new AnimationNinja(frameDuration, regions, 2);


        // Texturas:
        sc08_ryoko_win = atlas.findRegion("sc08_ryoko_win");
