...
public class Screen2 extends BaseScreen {
	...
	public Screen2() {
	       actores = new MyActor[30];

	        for(Actor actor : actores) {
	            pixmap = createProceduralPixmap(500, 500);
	        ...
	        stage.addAction(sequence(delay(4), run(new Runnable() {
	            @Override
                public void run () {
	                ScreenManager.setScreen(TestScreens.screen1);
	            }
	        })));
	}
