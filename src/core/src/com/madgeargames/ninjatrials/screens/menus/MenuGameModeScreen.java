...
public class MenuGameModeScreen extends BaseScreen {
	...
	public MenuGameModeScreen() {
		...
		optionsTable.defaults().align(BaseTableLayout.LEFT); // Alineación
																// izquierda.
		optionsTable.setX(Constants.WIDTH * .37f); // Desplazamiento horizontal
													// del menú textual respecto
													// al centro de la pantalla
		optionsTable.setY(Constants.HEIGHT * .21f); // Desplazamiento vertical
													// del menú textual respecto
													// al centro de la pantalla
		...
		tb = new NinjaTextButton("STORY", Assets.skin) {
			...
			public void action() {
				...
				ScreenManager.gotoScreen("MenuSelectCharScreen");
			}
		};
